...
const SUBSCRIBE_TO_NOTIFICATIONS = 'SUBSCRIBE_TO_NOTIFICATIONS';
export const USER_SUBSCRIBE_TO_NOTIFICATIONS = `user.${SUBSCRIBE_TO_NOTIFICATIONS}`;
const UNSUBSCRIBE_TO_NOTIFICATIONS = 'UNSUBSCRIBE_TO_NOTIFICATIONS';
export const USER_UNSUBSCRIBE_TO_NOTIFICATIONS = `user.${UNSUBSCRIBE_TO_NOTIFICATIONS}`;
